      ...
      <div ref="modalContent" class="bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700/60 overflow-auto max-w-2xl w-full max-h-full rounded-lg shadow-lg">
        ...
        <div class="py-4 px-2">
          ...
          <div class="mb-3 last:mb-0">
            ...
            <ul class="text-sm">
              <li>
                <Link class="flex items-center p-2 text-gray-800 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700/20 rounded-lg" href="#0" @click="$emit('close-modal')">
