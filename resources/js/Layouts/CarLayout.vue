        ...
        <footer class="bg-[#002f6c] text-white pt-16 pb-8">
            <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-gray-300">
                            <li class="flex items-start gap-3">
                                ...
                                <div>
                                    <span class="block font-bold text-white">0800 123 4567</span>
                                    <span class="text-xs">Seg a Sex, das 8h às 18h</span>
                                </div>
                            </li>
                            <li class="flex items-start gap-3">
                                <MessageCircle class="w-5 h-5 text-[#00a550] mt-0.5"/> 
                                <div>
                                    <span class="block font-bold text-white">(11) 99999-9999</span>
                ...
                <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
                    <p>&copy; 2026 Leilo Master. Todos os direitos reservados.</p>
